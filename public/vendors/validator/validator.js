...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : 'Obrigatório',
        min             : 'entrada é muito curta',
        max             : 'entrada é muito longa',
        number_min      : 'muito baixo',
        number_max      : 'muito alta',
        url             : 'URL inválido',
        number          : 'não é um número',
        email           : 'endereço de e-mail é inválido',
        email_repeat    : 'e-mails não coincidem',
        password_repeat : 'senhas não são iguais',
        repeat          : 'nenhuma correspondência',
        complete        : 'entrada não está completa',
